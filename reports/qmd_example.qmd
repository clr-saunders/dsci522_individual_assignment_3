...
author: "Tiffany Timbers & Claire Saunders"
editor: visual
format:
  html:
    toc: true
...
In @fig-horse-sd we zoom in and look at the province of `{python} str(largest_sd)`, which had the largest spread of values in terms of standard deviation.
